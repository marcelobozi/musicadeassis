...
?>
    ...
    <title>Hinário - Cordeiro | Portal da Pastoral da Música | Paróquia São Francisco de Assis - Itapuã</title>
    ...
    <div class="row justify-content-center">
        <div class="col-md-10 col-12" style="padding-top:10px;font-size:.9em;font-family: Exo 2, sans-serif">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Cordeiro</li>
                    </ol>
                    </nav>
...
<div class="container-fluid" style="padding-top:40px;padding-bottom:25px;color:#fff;background-color:#ae0707">
  <div class="row justify-content-center">
    <div class="col-md-10 col-12">
      <h2 class="exo-2-four" style="color:#fff"><i class="fa fa-music" aria-hidden="true"></i> Cordeiro</h2>
    </div>
  </div>
</div>
...
<div class="col-md-12">
                      ...
                      <div class="alert alert-danger" role="alert">
                        O Cordeiro é parte fixa da Missa. A letra deve ser sempre a do Missal e não pode ser substituída por outra. <br>
                        <strong>Obs</strong>.: Algumas melodias acrescem no final a expressão “Vossa Paz”, essa variação se encontra nas gravações do Hinário da CNBB.
                      </div>
