...
?>
    ...
    <title>Hinário - Perdão | Portal da Pastoral da Música | Paróquia São Francisco de Assis - Itapuã</title>
    ...
    <div class="row justify-content-center">
        <div class="col-md-10 col-12" style="padding-top:10px;font-size:.9em;font-family: Exo 2, sans-serif">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Perdão (Ato Penitencial)</li>
                    </ol>
                    </nav>
                ...
                <!-- biblioteca -->
                 <div class="col-md-12">
                      <div class="alert alert-success" role="alert">
                        <div class="row">
                          ...
                          <div class="col-md-12 afasta20">
                            <div class="btn-group">
                              <a href="/hinario/partes-fixas/melodias-perdao/" class="btn btn-success active" aria-current="page"><i class="fa fa-flask" aria-hidden="true"></i> 1ª Fórmula</a>
                    ...
                    <div class="col-md-12">
                      ...
                      <h1 class="afasta30"><i class="fa fa-flask" aria-hidden="true"></i> 1ª Fórmula</h1>
                      <p style="margin-left:20px;margin-top:30px">
                            <strong>AS</strong>: Confesso a Deus todo-poderoso e a vós, irmãos e irmãs, que pequei muitas vezes por pensamentos e palavras, atos e omissões, por minha culpa, minha culpa, minha tão grande culpa. E peço à Virgem Maria, aos anjos e santos e a vós, irmãos e irmãs, que rogueis por mim a Deus, nosso Senhor.
                            <br><br>
                            <strong>PR</strong>: Deus todo-poderoso tenha compaixão de nós, perdoe os nossos pecados e nos conduza à vida eterna. <br>
                            <strong>ASS</strong>: Amém 
                            <br><br>
                            <strong>PR</strong>: Senhor, tende piedade de nós!<br>
                            <strong>ASS</strong>: Senhor, tende piedade de nós!<br><br>
                            <strong>PR</strong>: Cristo, tende piedade de nós!<br>
                            <strong>ASS</strong>: Cristo, tende piedade de nós!<br><br>
                            <strong>PR</strong>: Senhor, tende piedade de nós!<br>
                            <strong>ASS</strong>: Senhor, tende piedade de nós!
                    </p>
                  </div>
                  <div class="col-md-12 afasta20">
                      <!-- cards cordeiro -->
