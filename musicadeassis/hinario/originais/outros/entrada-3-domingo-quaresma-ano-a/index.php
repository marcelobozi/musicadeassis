...
?>
    ...
    <title>Tenho Os Olhos Sempre Fitos no Senhor - Pedro Afonso</title>
    ...
    <div class="row justify-content-center">
        <div class="col-md-10 col-12" style="padding-top:10px;font-size:.9em;font-family: Exo 2, sans-serif">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Entrada: Tenho os Olhos Sempre Fitos No Senhor</li>
                    </ol>
                    </nav>
        ...
        <div class="row justify-content-center">
            <div class="col-md-10 col-12">
                ...
                <div class="col-md-12 text-end">
                  <a class="btn btn-success btn-sm" href="https://wa.me/?text=Confira%20os%20cânticos%20originais%20do%20Portal%20da%20Pastoral%20da%20Música%20-%20Paróquia%20São%20Francisco%20de%20Assis%20-%20Itapuã%20https://musicadeassis.com.br/hinario/originais/outros/entrada-3-domingo-quaresma-ano-a/" target="_blank"><i class="fa fa-whatsapp" aria-hidden="true"></i></a>
                </div>
              </div>
                <div class="row afasta20">
                    <div class="col-md-2 col-3">
                        ...
                        <div class="col-md-6 col-9">
                            <h1 class="exo-2-four" style="font-weight:900;color:#ac5a0d">Entrada: Tenho os Olhos Sempre Fitos No Senhor</h1>
                            <h3 class="exo-2-four" style="color:#000">Para Domingo III da Quaresma - Ano A - Pedro Afonso</h3>
                            <h4><span class="badge text-bg-warning">Tom: Em</span></h4>
                        </div>
                </div>
                      ...
                      <div class="row afasta20">
                        <div class="col-md-12">
                            <audio controls class="w-100">
                                <source src="entrada.mp3" type="audio/mp3">
...
<div class="container-fluid" style="margin-bottom:100px">
    <div class="row justify-content-center">
        <div class="col-md-8 col-12" id="cantico">
            ...
            <div class="row">
                <div class="col-md-12">
                    <img src="entradab.png" class="img-fluid" alt="">
                </div>
