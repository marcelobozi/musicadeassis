  ...
  <div class="row justify-content-center">
    <div class="col-md-10 col-12">
      <div class="row">
        ...
        <div class="col-md-12 afasta20">
          <div class="alert alert-warning" role="alert">
             ...
             <ul>
              <li><strong>3º Domingo - 8h</strong>: sem quipe fixa desde fevereiro.</li>
              <li><strong>3º Domingo - 17h</strong>: sem equipe fixa desde fevereiro.</li>
              <li><strong>5º Domingo - 10h</strong>: sem equipe fixa.</li>
             </ul>
             <hr>
      ...
      <div class="row" style="margin-top:40px">
        <div class="col-md-12">
<!-- ACCORDEON -->
 <a href="/img/2026/marco/escala-v4.png">
<img src="/img/2026/marco/escala-v4.png" alt="" class="img-fluid">
</a>
<!-- ACCORDEON -->
        </div>
      </div>
