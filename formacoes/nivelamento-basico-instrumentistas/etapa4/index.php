...
$_SESSION['final_missa'] = $_POST['repertorio_final_missa'] ?? 'Não informado';
$_SESSION['quaresma'] = $_POST['quaresma'] ?? 'Não informado';

$brutos = $_POST['comunhao'] ?? [];
$limpos = array_filter(array_map('trim', $brutos));
$lista = !empty($limpos) 
    ? implode(';', $limpos) 
    : "";
$_SESSION['comunhao'] = $lista;
?>
<!doctype html>
<html lang="pt-BR">
  <head>
...
?>
    ...
    <title>Nivelamento Novos Membros - Etapa 4</title>
        ...
        <div class="col-md-10 col-12" style="padding-top:10px;font-size:.9em;font-family: Exo 2, sans-serif">
                    ...
                    <ol class="breadcrumb">
                       ...
                       <li class="breadcrumb-item active" aria-current="page">1</li>
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Bloco 4</li>
                    </ol>
                    </nav>
            ...
            <div class="col-md-10 col-12">
                <div class="row">
                        ...
                        <div class="col-md-12 col-12">
                            <h1 class="exo-2-four"><i class="fa fa-comment" aria-hidden="true"></i> BLOCO 4 — Técnica Musical Aplicada à Liturgia</h1>
                        </div>
                </div>
...
<form name="etapa1" id="etapa1" action="/formacoes/nivelamento-basico-instrumentistas/etapa5/" method="post">
                <!-- bloco A -->
                <div class="row afasta60">
                    <div class="col-md-12">
                        <div class="alert alert-secondary" role="alert">
                            <div class="row">
                                <div class="col-md-12">
                                    <h4 style="color:#000">10. Durante a consagração, o instrumentista deve:</h4>
                            ...
                            <div class="row afasta20">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" name="consagracao[]" type="checkbox" value="Criar uma ambientação musical suave" id="bloco1a">
                                            <label class="form-check-label" for="bloco1a">
                                                Criar uma ambientação musical suave
                                            </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" name="consagracao[]" type="checkbox" value="Improvisar livremente" id="bloco1b">
                                            <label class="form-check-label" for="bloco1b">
                                                Improvisar livremente 
                                            </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" name="consagracao[]" type="checkbox" value="Manter silêncio absoluto" id="bloco1c">
                                            <label class="form-check-label" for="bloco1c">
                                                Manter silêncio absoluto
                                            </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" name="consagracao[]" type="checkbox" value="Acompanhar o sacerdote" id="bloco1d">
                                            <label class="form-check-label" for="bloco1d">
                                                Acompanhar o sacerdote
                                            </label>
                                    </div>
                ...
                <div class="row afasta30">
                    <div class="col-md-12">
                        <div class="alert alert-secondary" role="alert">
                            <div class="row">
                                <div class="col-md-12">
                                    <h4 style="color:#000">11. O uso de improvisos instrumentais na Missa:</h4>
                                </div>
                            </div>
                            <div class="row afasta20">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-check">
                                    <input class="form-check-input" type="radio" name="improvisos" value="É sempre recomendado" id="nunca-atuei" onClick="mostraAvancar()">
                                    ...
                                    <div class="form-check">
                                    <input class="form-check-input" type="radio" name="improvisos" value="É proibido em qualquer situação" id="menos-um-ano" onClick="mostraAvancar()">
                                    ...
                                    <div class="form-check">
                                    <input class="form-check-input" type="radio" name="improvisos" value="Deve ser discreto e subordinado ao rito" id="um-a-3-anos" onClick="mostraAvancar()">
                                    <label class="form-check-label" for="um-a-3-anos">
                                        Deve ser discreto e subordinado ao rito
                                    </label>
                                    </div>

                                    <div class="form-check">
                                    <input class="form-check-input" type="radio" name="improvisos" value="Serve para mostrar criatividade" id="mais-3-anos" onClick="mostraAvancar()">
                                    <label class="form-check-label" for="mais-3-anos">
                                        Serve para mostrar criatividade 
                                    </label>
                                    </div>
