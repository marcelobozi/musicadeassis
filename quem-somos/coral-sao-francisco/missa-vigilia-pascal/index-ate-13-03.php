...
<!-- progresso -->
                    ...
                    <div class="col-md-12 afasta20">
                          <div class="row">
                            <div class="col-md-12">
                              <h4>SANTO - VOZ DE HOMENS  (BAIXOS E TENORES)</h4>
                            </div>
                            <div class="col-md-12">
                            <div class="ratio ratio-16x9">
                        <iframe src="https://www.youtube.com/embed/wyraoLDgbbY?rel=0" title="YouTube video" allowfullscreen></iframe>
                      </div>
                            </div>
                          </div>
                    </div>
                    ...
                    <div class="row afasta20">
                            <div class="col-md-12">
                              <h4>SANTO - VOZ MULHERES (SOPRANO E CONTRALTOS)</h4>
                            </div>
                            <div class="col-md-12">
                            <div class="ratio ratio-16x9">
                        <iframe src="https://www.youtube.com/embed/Zhp3SUv2vi8?rel=0" title="YouTube video" allowfullscreen></iframe>
                      </div>
                            </div>
                          </div>
                    </div>
