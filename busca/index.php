...
?>
    ...
    <title>Busca por "<?php echo $termo;?>" - Portal da Pastoral da Música - Paróquia São Francisco de Assis - Itapuã</title>
    ...
    <div class="row justify-content-center">
        <div class="col-md-10 col-12" style="padding-top:10px;font-size:.9em;font-family: Exo 2, sans-serif">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Resultado de busca por "<?php echo $termo; ?>"</li>
                    </ol>
                    </nav>
        ...
        <div class="col-md-10 col-11" style="padding-top:40px;padding-bottom:10px">
          <div class="row">
            ...
            <div class="row afasta30" style="margin-bottom:40px">
                <div class="col-md-12">
                    <h1><i class="fa fa-search" aria-hidden="true"></i> Busca por "<span style="color:#00F"><?php echo $termo; ?></span>":</h1>
                </div>
              
                <div class="col-md-12 afasta40">
                  <h4>Estamos ainda indexando conteúdos para a busca.</h4>
                  <p>Enquanto isso, você pode não localizar nenhuma correspondência pelo termo "<?php echo $termo; ?>".</p>
                </div>
            </div>
        </div>
    </div>
