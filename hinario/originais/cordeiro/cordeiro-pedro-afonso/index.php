...
?>
    ...
    <title>Cordeiro - Pedro Afonso</title>
    ...
    <div class="row justify-content-center">
        <div class="col-md-10 col-12" style="padding-top:10px;font-size:.9em;font-family: Exo 2, sans-serif">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Cordeiro - Pedro Afonso</li>
                    </ol>
                    </nav>
        ...
        <div class="row justify-content-center">
            <div class="col-md-10 col-12">
                ...
                <div class="col-md-12 text-end">
                  <a class="btn btn-success btn-sm" href="https://wa.me/?text=Confira%20os%20cânticos%20originais%20do%20Portal%20da%20Pastoral%20da%20Música%20-%20Paróquia%20São%20Francisco%20de%20Assis%20-%20Itapuã%20https://musicadeassis.com.br/hinario/originais/cordeiro/cordeiro-pedro-afonso/" target="_blank"><i class="fa fa-whatsapp" aria-hidden="true"></i></a>
                </div>
              </div>
                      ...
                      <div class="row afasta20">
                        <div class="col-md-12">
                            <audio controls class="w-100">
                                <source src="cordeiro.mp3" type="audio/mp3">
...
<div class="container-fluid" style="margin-bottom:100px">
    <div class="row justify-content-center">
        <div class="col-md-8 col-12" id="cantico">
            ...
            <div class="row">
                <div class="col-md-12">
                    <img src="cifra-cordeiro-pedro-afonso.png" class="img-fluid" alt="">
                </div>
