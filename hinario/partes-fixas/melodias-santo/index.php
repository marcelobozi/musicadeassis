...
?>
    ...
    <title>Hinário - Santo | Portal da Pastoral da Música | Paróquia São Francisco de Assis - Itapuã</title>
    ...
    <div class="row justify-content-center">
        <div class="col-md-10 col-12" style="padding-top:10px;font-size:.9em;font-family: Exo 2, sans-serif">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Santo</li>
                    </ol>
                    </nav>
...
<div class="container-fluid" style="padding-top:40px;padding-bottom:25px;color:#fff;background-color:#5c0a7a">
  <div class="row justify-content-center">
    <div class="col-md-10 col-12">
      <h2 class="exo-2-four" style="color:#fff"><i class="fa fa-music" aria-hidden="true"></i> Santo</h2>
    </div>
  </div>
</div>
...
<div class="col-md-12">
                      ...
                      <div class="alert alert-dark" role="alert">
                        O Santo é parte fixa da Missa. Essa letra não pode ser substituída por outra. 
                      </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="ratio ratio-16x9">
          <iframe id="youtube" src="https://www.youtube.com/embed/qmFkpCJO5cE?rel=0" title="YouTube video" allowfullscreen></iframe>
        </div>
      </div>
