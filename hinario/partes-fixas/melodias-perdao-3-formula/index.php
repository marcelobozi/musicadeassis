...
?>
    ...
    <title>Hinário - Perdão 3ª Fórmula | Portal da Pastoral da Música | Paróquia São Francisco de Assis - Itapuã</title>
    ...
    <div class="row justify-content-center">
        <div class="col-md-10 col-12" style="padding-top:10px;font-size:.9em;font-family: Exo 2, sans-serif">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Perdão (Ato Penitencial) - 3ª Fórmula</li>
                    </ol>
                    </nav>
...
<div class="container-fluid" style="padding-top:40px;padding-bottom:25px;color:#fff;background-color:#3d6a04">
  <div class="row justify-content-center">
    <div class="col-md-10 col-12">
      <h2 class="exo-2-four" style="color:#fff"><i class="fa fa-music" aria-hidden="true"></i> Perdão (Ato Penitencial)</h2>
    </div>
  </div>
</div>
                ...
                <!-- biblioteca -->
                 <div class="col-md-12">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-12 afasta20">
                            <div class="btn-group">
                              ...
                              <a href="/hinario/partes-fixas/melodias-perdao-2-formula/" class="btn btn-success"><i class="fa fa-flask" aria-hidden="true"></i><i class="fa fa-flask" aria-hidden="true"></i> 2ª Fórmula</a>
                              <a href="/hinario/partes-fixas/melodias-perdao-3-formula/" class="btn btn-success active"><i class="fa fa-flask" aria-hidden="true"></i><i class="fa fa-flask" aria-hidden="true"></i><i class="fa fa-flask" aria-hidden="true"></i> 3ª Fórmula</a>
                          </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-md-12">
                      ...
                      <h1 class="afasta30"><i class="fa fa-flask" aria-hidden="true"></i><i class="fa fa-flask" aria-hidden="true"></i><i class="fa fa-flask" aria-hidden="true"></i> 3ª Fórmula</h1>
                      <p style="margin-left:20px;margin-top:30px">
                         <strong>PR</strong>: Senhor, que viestes salvar os corações arrependidos, tende piedade de nós.<br>
                        <strong>AS</strong>: Senhor, tende piedade de nós.<br>
                        <br>
                        <strong>PR</strong>: Cristo, que viestes chamar os pecadores, tende piedade de nós.<br>
                        <strong>AS</strong>: Cristo, tende piedade de nós.<br>
                        <br>
                        <strong>PR</strong>: Senhor, que intercedei por nós junto do Pai, tende piedade de nós.<br>
                        <strong>AS</strong>: Senhor, tende piedade de nós.<br>
                    </p>
                  </div>
                  <div class="col-md-12 afasta20">
